pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/pottsdj/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('pottsdj2-225')   // <---- Change this to match your kubernetes cluster credentials
    }
